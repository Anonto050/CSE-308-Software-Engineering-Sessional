...
public class Tesla implements Car {
    ...
    Color color = colorFactory.getColor("White");

    DriveSystemFactory driveSystemFactory = new DriveSystemFactory();
    DriveSystem driveSystem = driveSystemFactory.getDriveSystem("All wheel");

    manufacturer_countryFactory manufacturerCountryFactory = new manufacturer_countryFactory();
    manufacturer_country manufacturerCountry = manufacturerCountryFactory.getManufacturerCountry("US");
